        ...
        <div class="col-md-6">
            ...
            <div class="form-group mb-3">
                ...
                <select name="jenis_pasien"
                        class="form-control @error('jenis_pasien') is-invalid @enderror"
                        style="border: 1px solid #ccc; padding: 10px;" required>
                    <option value="Ortho" {{ old('jenis_pasien', $pasien->jenis_pasien) == 'Ortho' ? 'selected' : '' }}>Ortho</option>
                    <option value="Bukan Ortho" {{ old('jenis_pasien', $pasien->jenis_pasien) == 'Bukan Ortho' ? 'selected' : '' }}>Umum</option>
                </select>
                @error('jenis_pasien')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
